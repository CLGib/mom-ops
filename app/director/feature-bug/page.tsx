...
import FeatureBugBoard from "../../admin/feature-bug/FeatureBugBoard";

export const dynamic = "force-dynamic";

const STATUSES = ["backlog", "in_progress", "qa", "done", "wont_fix"] as const;

export default async function DirectorFeatureBugPage() {
  ...
  return (
    <main className="app-shell">
      ...
      <p className="form-note" style={{ marginBottom: "var(--space-lg)" }}>
        <Link href="/director/feedback" className="link">Submit a feature or bug</Link>
        {" · "}
